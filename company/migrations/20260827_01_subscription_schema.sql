...
-- Ruleaza pe baza din company/.env (restosoft_company in productie), prin
-- scripts/migration-manifest.txt. Fara nume de baza hardcodat, ca sa fie
-- portabila intre medii.
