...
const create_supplier_with_documents_dto_1 = require("./suppliers/dto/create-supplier-with-documents.dto");
...
let SuppliersMicroController = class SuppliersMicroController {
    ...
    createWithDocuments(dto) { return this.service.createWithDocuments(dto); }
