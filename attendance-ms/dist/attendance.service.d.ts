...
export declare class AttendanceService implements OnModuleInit {
    ...
    constructor(shiftRepository: Repository<Shift>, presenceRepository: Repository<Presence>, presenceInflexionRepository: Repository<PresenceInflexion>, notificationsClient: ClientProxy, httpService: HttpService);
    onModuleInit(): Promise<void>;
    private sendAttendanceNotification;
    private addEmployeePoints;
