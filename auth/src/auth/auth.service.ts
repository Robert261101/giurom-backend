...
export class AuthService {
  ...
  async signIn(
    ...
    let employeeData: { id: number; email: string; first_name: string; last_name: string; phone: string; profile_image: string | null; birth_date: string | null; department_default_id: number | null; work_location_default_id: number | null } | null = null;
    if (isEmail) {
    ...
    // Obține roles și permissions pentru utilizator
  ...
  async refreshToken(refreshToken: string): Promise<{ access_token: string; refresh_token: string }> {
    try {
      ...
      const employeeData: { id: number; email: string; first_name: string; last_name: string; phone: string; profile_image: string | null; birth_date: string | null; department_default_id: number | null; work_location_default_id: number | null } | null = await this.usersService.findEmployeeByEmail(payload.email) || 
