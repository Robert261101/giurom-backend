...
__decorate([
    (0, typeorm_1.ManyToOne)(() => recurrence_rule_entity_1.RecurrenceRule, (rule) => rule.events, {
        onDelete: 'SET NULL',
        nullable: true
    }),
    (0, typeorm_1.JoinColumn)({ name: 'recurrence_id' }),
    __metadata("design:type", recurrence_rule_entity_1.RecurrenceRule)
], CalendarEvent.prototype, "recurrence_rule", void 0);
__decorate([
