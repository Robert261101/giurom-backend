...
export declare class CalendarService {
    ...
    constructor(eventRepo: Repository<CalendarEvent>, recurrenceRepo: Repository<RecurrenceRule>, employeeRepo: Repository<Employee>);
    ...
    removeEvent(id: number, currentUserId?: number): Promise<{
        success: true;
    }>;
