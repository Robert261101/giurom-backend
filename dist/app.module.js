...
const company_ref_entity_1 = require("./locations/entity/company-ref.entity");
    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRoot({
                ...
                database: process.env.DB_DATABASE || 'giurom_locations',
                entities: [
                    work_location_entity_1.WorkLocation,
                    company_ref_entity_1.CompanyRef,
