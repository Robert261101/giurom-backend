    ...
    (0, common_1.Module)({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forRoot({
                ...
                entities: [recipe_entity_1.Recipe, recipe_category_entity_1.RecipeCategory, recipe_product_entity_1.RecipeProduct, recipe_preparation_entity_1.RecipePreparation, recipe_label_entity_1.RecipeLabel],
            ...
            typeorm_1.TypeOrmModule.forFeature([recipe_entity_1.Recipe, recipe_category_entity_1.RecipeCategory, recipe_product_entity_1.RecipeProduct, recipe_preparation_entity_1.RecipePreparation, recipe_label_entity_1.RecipeLabel]),
        ],
        controllers: [recipes_micro_controller_1.RecipesMicroController, recipes_http_controller_1.RecipesHttpController],
        providers: [recipes_service_1.RecipesService, recipes_preparations_service_1.RecipePreparationsService, recipes_labels_service_1.RecipesLabelsService],
    })
], AppModule);
