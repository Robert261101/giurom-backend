...
let RecipesHttpController = class RecipesHttpController {
    constructor(recipes, preps, labels) {
    ...
    findAll(q) {
        ...
        return this.recipes.findAllRecipes(Number.isFinite(page) && page > 0 ? page : 1, Number.isFinite(limit) && limit > 0 ? limit : 50, q.search, category_id);
    }
    create(dto) { return this.recipes.createRecipe(dto); }
    categoriesFindAll(q) {
        const page = Number.parseInt(q.page, 10);
        const limit = Number.parseInt(q.limit, 10);
        return this.recipes.findAllRecipeCategories(Number.isFinite(page) && page > 0 ? page : 1, Number.isFinite(limit) && limit > 0 ? limit : 50, q.search);
    }
    categoryFindOne(id) { return this.recipes.findRecipeCategoryById(Number(id)); }
    categoryCreate(dto) { return this.recipes.createRecipeCategory(dto); }
    categoryUpdate(id, dto) { return this.recipes.updateRecipeCategory(Number(id), dto); }
    categoryRemove(id) { return this.recipes.deleteRecipeCategory(Number(id)); }
    ...
    removeRecipeProduct(id) { return this.recipes.removeProductFromRecipe(Number(id)); }
    getRecipeProducts(id) { return this.recipes.findRecipeProducts(Number(id)); }
    findOne(id) { return this.recipes.findRecipeById(Number(id)); }
    update(id, dto) { return this.recipes.updateRecipe(Number(id), dto); }
    remove(id) { return this.recipes.deleteRecipe(Number(id)); }
