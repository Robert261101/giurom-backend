...
export class CreateWorkLocationDto {
  @ApiProperty({
    description: 'ID-ul companiei la care aparține locația',
    example: 1,
  })
  ...
  @ApiProperty({
    description: 'Numele locației de lucru',
    example: 'Sediul Central București',
    maxLength: 255,
  })
  ...
  @ApiProperty({
    description: 'Adresa completă a locației',
    example: 'Str. Exemplu nr. 123, Sector 1, București',
  })
  ...
  @ApiProperty({
    description: 'Orașul în care se află locația',
    example: 'București',
    maxLength: 100,
  })
  ...
  @ApiProperty({
    description: 'Județul în care se află locația',
    example: 'București',
    maxLength: 100,
  })
  ...
  @ApiProperty({
    description: 'Codul poștal al locației',
    example: '010101',
    maxLength: 20,
    required: false,
  })
  ...
  @ApiProperty({
    description: 'Țara în care se află locația',
    example: 'Romania',
    maxLength: 100,
    default: 'Romania',
  })
  ...
  @ApiProperty({
    description: 'Numărul de telefon al locației',
    example: '+40212345678',
    maxLength: 20,
    required: false,
  })
  ...
  @ApiProperty({
    description: 'Adresa de email pentru locația respectivă',
    example: 'bucuresti@giurom.com',
    maxLength: 255,
    required: false,
  })
  ...
  @ApiProperty({
    description: 'ID-ul angajatului responsabil pentru locație',
    example: 1,
    default: 1,
    required: false,
  })
  ...
  @ApiProperty({
    description: 'Note despre locația de lucru',
    example: 'Sediul principal cu 50 de angajați',
    required: false,
  })
