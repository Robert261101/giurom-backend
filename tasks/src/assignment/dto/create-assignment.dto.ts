...
import { AssignmentStatus, Priority, AssignmentMode } from '../entity/task-assignment.entity';
...
export class CreateAssignmentDto {
  ...
  @ApiProperty({
    description: 'ID-ul locației pentru care este creat task-ul',
    example: 1,
    required: false
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Modul de asignare pentru taskurile de grup',
    enum: AssignmentMode,
    example: AssignmentMode.FIRST_COME_FIRST_SERVED,
    required: false
  })
  @IsOptional()
