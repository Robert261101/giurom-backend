...
export class TemplateController {
  ...
  findAll(@Query('locationId') locationId: string): Promise<TaskTemplate[]> {
    console.log('🔍 DEBUG TemplateController.findAll - locationId query param (OBLIGATORIU):', locationId);
    ...
    console.log('🔍 DEBUG TemplateController.findAll - locationIdNumber:', locationIdNumber);
  ...
  findOne(
    ...
    console.log('🔍 DEBUG TemplateController.findOne - id:', id, 'locationId query param (OBLIGATORIU):', locationId);
    ...
    console.log('🔍 DEBUG TemplateController.findOne - locationIdNumber:', locationIdNumber);
