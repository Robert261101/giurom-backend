...
export declare class StockService {
    ...
    constructor(productRepo: Repository<Product>, stockRepo: Repository<Stock>, txRepo: Repository<StockTransaction>, wasteRecordRepo: Repository<WasteRecord>, categoryRepo: Repository<Category>);
    ...
    findCategoriesByType(type: string): Promise<Category[]>;
    findProductsWithCategories(): Promise<Product[]>;
    findProductWithCategories(id: number): Promise<Product>;
