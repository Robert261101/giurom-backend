...
export declare class StockHttpController {
    ...
    getCategoriesByType(type: string): Promise<import("./entities/category.entity").Category[]>;
    getProductsWithCategories(): Promise<import("./entities/product.entity").Product[]>;
    assignCategoriesToProduct(id: string, assignCategoryDto: AssignCategoryDto): Promise<import("./entities/product.entity").Product>;
}
