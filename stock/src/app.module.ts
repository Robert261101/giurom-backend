...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      entities: [Product, Stock, StockTransaction, WasteRecord, ConsumptionRecord, Category, OrderList],
    ...
    TypeOrmModule.forFeature([Product, Stock, StockTransaction, WasteRecord, ConsumptionRecord, Category, OrderList]),
  ],
